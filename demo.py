...
def main(Params):
    ...
    for split in range(0, numRuns):
        ...
        model_ft = nn.DataParallel(model_ft)
            ...
            # test_input = torch.rand([128, 1, 128, 48])     
            # test_output = model_ft(test_input)
            # output should be in shape [128, 4]
...
def parse_args():
    ...
    parser.add_argument('--folder', type=str, default='Saved_Models/Fbank_Kfold/',
    ...
    parser.add_argument('--audio_feature', type=str, default='Fbank',
