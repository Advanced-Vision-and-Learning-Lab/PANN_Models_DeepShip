...
def main(Params):
    ...
    for split in range(0, NumRuns):
        ...
        if (Params['TSNE_visual']):
            ...
            if Params['Parallelize']:
                if Params['Model_name'] == 'CNN_14':
                    try:
                        model.module.fc_audioset = nn.Sequential()
                    except:
        ...
        # Convert to dataframe and save as .CSV fileCNN_14
...
def parse_args():
    ...
    parser.add_argument('--folder', type=str, default='Saved_Models/lr_test',
    ...
    parser.add_argument('--val_batch_size', type=int, default=64 #256
                        ,
                        help='input batch size for validation (default: 512)')
    parser.add_argument('--test_batch_size', type=int, default=64 #256
                        ,
    ...
    parser.add_argument('--audio_feature', type=str, default='LogMS',
                        help='Audio feature for extraction')
    parser.add_argument('--optimizer', type = str, default = 'Adagrad',
                       help = 'Select optimizer')
    parser.add_argument('--sample_rate', type = int, default = 32000,
                        help = 'Select dataset sample rate')
