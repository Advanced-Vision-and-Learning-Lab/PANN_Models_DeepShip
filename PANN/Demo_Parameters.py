...
def Parameters(args):
    ...
    out_channels = {"resnet50": 2048, "resnet18": 512, "efficientnet": 1280, 
                    ...
                    "regnet": 400, "TDNN": 256,"DNN": 256, "CNN_14": 2048,"ResNet38": 2048,"MobileNetV1":2048,"Res1dNet31":2048,"Wavegram_Logmel_Cnn14":2048, "Cnn14":2048, "Cnn14_8k":2048, "Cnn14_16k":2048 }
    ...
    if scale == 1:
        ...
        in_channels = {"resnet50": 2048, "resnet18": 512, "efficientnet": 1280, "regnet": 400,
                       ...
                       'CNN_14': 2048,'ResNet38': 2048,'MobileNetV1':2048,'Res1dNet31':2048,'Wavegram_Logmel_Cnn14':2048,"Cnn14":2048,"Cnn14_8k":[3,3],"Cnn14_16k":[3,3]}
        kernel_size = {"resnet50": [4,4],  "resnet18": [4,4], "efficientnet": [4,4], "regnet": [4,4],
                       ...
                       'CNN_14': [3,3],'ResNet38': [3,3],'MobileNetV1':[3,3],'Res1dNet31':[3,3],'Wavegram_Logmel_Cnn14':[3,3],"Cnn14":[3,3],"Cnn14_8k":[3,3],"Cnn14_16k":[3,3]}
