...
def get_file_location(Network_parameters,split):
    ...
    #Change dataset name based on sampling rate
    Network_parameters['Dataset'] = '{}_{}'.format(Network_parameters['Dataset'],
                                                   Network_parameters['sample_rate'])
    #Save audio datasets based on features
    if (Network_parameters['histogram']):
        
        if Network_parameters['audio_features']:
            if (Network_parameters['parallel'] and Network_parameters['use_pretrained'] ):
                filename = '{}/Pretrained/{}/{}/{}/Parallel/{}/Run_{}/'.format(Network_parameters['folder'],
                ...
                filename = '{}/Scratch/{}/{}/{}/Series/{}/Run_{}/'.format(Network_parameters['folder'],
                                             Network_parameters['mode'],
                                             Network_parameters['Dataset'],
                                             Network_parameters['hist_model'],
                                             Network_parameters['feature'],
    ...
    # Baseline model
        ...
        if Network_parameters['audio_features'] and Network_parameters['use_pretrained']:
            
            filename = '{}/Pretrained/{}/{}/GAP_{}/{}/Run_{}/'.format(Network_parameters['folder'],
                                         Network_parameters['mode'],
                                         Network_parameters['Dataset'],
            ...
            filename = '{}/Scratch/{}/{}/GAP_{}/Run_{}/'.format(Network_parameters['folder'],
                                         Network_parameters['mode'],
                                         Network_parameters['Dataset'],
                                         Network_parameters['Model_name'],
                                         str(split + 1))
