...
def main(Params):
    ...
    for split in range(0, numRuns):
        ...
        optimizer_ft = optim.Adagrad([
                    {'params': model_ft.module.backbone.parameters(), 'lr': Params['lr']/100},
                    {'params': model_ft.module.fc.parameters(), 'lr': Params['lr']},
                ])
...
def parse_args():
    ...
    parser.add_argument('--val_batch_size', type=int, default= 64 #512
                        ,
